...
| --- | --- | ---: | ---: | --- |
| `unblock-access` | `blocked` | `2` | `2` | Set DEEPSEEK_API_KEY in the operator shell; never commit or print the value. |
...
| Phase | Status | Rows | Blocked | Next action |
| --- | --- | ---: | ---: | --- |
| `unblock-access` | `blocked` | `3` | `3` | Collect three exact 20-pair reviewer packets with integrity and independent-review attestations. |
...
| `collect-source` | `blocked` | `2` | `2` | Installer enforcement is supporting evidence, not native proof. |
...
| Installer support | `False` | `true` | `blocked` | Installer enforcement is supporting evidence, not native proof. |
