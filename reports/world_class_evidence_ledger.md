...
| `native-permission-enforcement` | `pending` | `missing` | `external` | native-enforced targets 0; installer-enforced targets 0 | Integrate a real target-client or external installer runtime guard before claiming native permission enforcement. |
...
| Installer support | `False` | `true` | `blocked` |
