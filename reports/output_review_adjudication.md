...
| --- | --- | --- | --- | ---: | --- |
| team-bootstrap | pending | hidden | pending |  |  |
| serial-gate | pending | hidden | pending |  |  |
| rework-safety | pending | hidden | pending |  |  |
| resume-ledger | pending | hidden | pending |  |  |
| near-neighbor-explanation | pending | hidden | pending |  |  |

## Reviewer Checklist

| Case | Readiness | Answer key | Decision file |
| --- | --- | --- | --- |
| `team-bootstrap` | `awaiting-decision` | `hidden` | `/Volumes/Code/team-worker/agent-team-work/reports/output_review_decisions.json` |
| `serial-gate` | `awaiting-decision` | `hidden` | `/Volumes/Code/team-worker/agent-team-work/reports/output_review_decisions.json` |
| `rework-safety` | `awaiting-decision` | `hidden` | `/Volumes/Code/team-worker/agent-team-work/reports/output_review_decisions.json` |
| `resume-ledger` | `awaiting-decision` | `hidden` | `/Volumes/Code/team-worker/agent-team-work/reports/output_review_decisions.json` |
| `near-neighbor-explanation` | `awaiting-decision` | `hidden` | `/Volumes/Code/team-worker/agent-team-work/reports/output_review_decisions.json` |
...
- blind pack: `/Volumes/Code/team-worker/agent-team-work/reports/output_blind_review_pack.json`
- decisions: `/Volumes/Code/team-worker/agent-team-work/reports/output_review_decisions.json`
